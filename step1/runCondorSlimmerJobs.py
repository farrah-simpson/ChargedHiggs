...
inputDir='/eos/uscms/store/user/lpcljm/FWLJMET_crab_1lep2017_UL_fixed_new/' #FWLJMET_crab_1lep2017_UL_fixed_new/'#FWLJMET102X_1lep2017UL_X53/'
#inputDir='/isilon/hadoop/store/group/bruxljm/FWLJMET102X_1lep'+str(Year)+'_Oct2019/' # or 2018
outputDir='/eos/uscms/store/user/fsimpson/FWLJMET106X_1lep2017UL_step1_new/nominal/'#'/eos/uscms/store/user/lpcbril/MC_test/FWLJMET102X_1lep'+str(Year)+'_Oct2019_4t_080420_step1_new_Pt40_Eta2p4/nominal/'#'/eos/uscms/store/user/ssagir/FWLJMET102X_1lep'+str(Year)+'_Oct2019_4t_080420_step1/nominal/' # or 2018
