...
inDir = '/uscms_data/d3/fsimpson/scratch/FWLJMETstuff/CMSSW_10_6_19/src/ChargedHiggs/step2/FWLJMET106X_1lep2017UL_step2_condorLogs/nominal' 
#'/user_data/jlee/chargedHiggs/CMSSW_7_4_7/src/FOR_EPS2017/slimmers/step2_htb_Moriond17_newIDtrig/LJMet80X_1lep_100217_step2_xsecEffFixed_condorLogs/nominal'
...
for shift in shifts:
	...
	for file in logfilelist:
		...
		if os.path.exists(eFile): 
			...
			statement3 = not ('error' in errFdata or 'Error' in errFdata or 'There was a crash.' in errFdata) or len(errFdata.split())>25
			print errFdata
