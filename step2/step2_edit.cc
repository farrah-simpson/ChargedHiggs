...
//std::cout<<"OKAY HARDCODED 1"<<std::endl;   

     HT_4jets = theJetPt_JetSubCalc_PtOrdered->at(0)+theJetPt_JetSubCalc_PtOrdered->at(1)+theJetPt_JetSubCalc_PtOrdered->at(2);
     for(unsigned int ijet =3 ; ijet < theJetPt_JetSubCalc_PtOrdered->size(); ijet++){
         HT_other += theJetPt_JetSubCalc_PtOrdered->at(ijet);
//std::cout<<"OKAY LOOP 2"<<std::endl;   

     }
     if (NJets_JetSubCalc >= 3){  // was >
         HT_ratio = HT_4jets/HT_other;
         ratio_HTdHT4leadjets = AK4HT/HT_4jets;
//std::cout<<"OKAY LOOP3"<<std::endl;   
...
//std::cout<<"OKAY MIDDLE START"<<std::endl;   
...
//std::cout<<"OKAY MIDDLE END"<<std::endl;   
...
//std::cout<<"OKAY BAD TOP"<<std::endl;   
...
//std::cout<<"OKAY centrality"<<std::endl;   
...
//std::cout<<"OKAY Wolfram"<<std::endl;   
...
//std::cout<<"OKAY BDT TRIJET"<<std::endl;   
...
//std::cout<<"OKAY HOT TRIJET"<<std::endl;   
...
//std::cout<<"OKAY ENDING LOOP"<<std::endl;   
...
//std::cout<<"OKAY LAST LOOP"<<std::endl;   
