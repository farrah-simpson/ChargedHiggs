...
ntupleDir = '/isilon/hadoop/store/user/fsimpson/UL16APV/step3_XGB_final/nominal/'#'root://cmseos.fnal.gov//store/user/fsimpson/FWLJMET106XUL_singleLep2017UL_RunIISummer20v2_step2/nominal/' 
...
#ntupleDir  = '/isilon/hadoop/store/user/fsimpson/FWLJMET106XUL_singleLep2016APVUL_RunIISummer20v2_step2/nominal/'#'root://cmseos.fnal.gov//store/user/fsimpson/UL17/step3_XGB/nominal/'
...
iPlot = 'NJets'#NPU' #choose a discriminant from plotList below!
...
plotList = {#discriminantName:(discriminantLJMETName, binning, xAxisLabel)
	...
	'NPU':('NJetsPU_JetSubCalc',linspace(0, 7, 8).tolist(),';PU jet multiplicity'),
