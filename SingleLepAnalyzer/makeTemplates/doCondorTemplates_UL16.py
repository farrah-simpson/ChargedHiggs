...
if 1==1:
	...
	pfix='templates_R16_final_'+region
	if not categorize: pfix='kinematics_R16_XGBcut_'+region#'kinematics_'+region
	pfix+='_'+date#+'_'+time
...
Transfer_Input_Files = analyze_UL16.py,doHists_UL16.py,utils.py,weights_UL16.py,samples.py
request_memory = 8000
