...
step1Dir = '/mnt/hadoop/store/group/bruxljm/FWLJMET102X_1lep20'+year[1:]+'_Oct2019_X53_061321_step1hadds/nominal'#'/mnt/hadoop/store/group/bruxljm/FWLJMET102X_1lep'+year+'_Oct2019_4t_071420_step1hadds/nominal'
...
#		  'TTJets2L2nuTT1b','TTJets2L2nuTT2b','TTJets2L2nuTTbb','TTJets2L2nuTTcc','TTJets2L2nuTTjj',
          'TTJetsHad0','TTJetsHad700','TTJetsHad1000','TTJetsSemiLep01','TTJetsSemiLep02','TTJetsSemiLep700','TTJetsSemiLep1000','TTJets2L2nu0','TTJets2L2nu700','TTJets2L2nu1000',
...
if year=='R16':
	...
	bkgList+= ['WJetsMG12001','WJetsMG12002','WJetsMG12003','WJetsMG25001','WJetsMG25002','WJetsMG25003','WJetsMG25004','Tbs','TTZlM1to10','TTJetsSemiLep03','TTJetsSemiLep04','TTJetsSemiLep05']
			   #'TTJetsSemiLepNjet0TTjj3','TTJetsSemiLepNjet0TTjj4','TTJetsSemiLepNjet0TTjj5','Tbs','TTZlM1to10','TTJetsSemiLep03','TTJetsSemiLep04','TTJetsSemiLep05']
elif year=='R18':
...
catList = ['is'+cat[0]+'_nT'+cat[1]+'_nW'+cat[2]+'_nB'+cat[3]+'_nJ'+cat[4] for cat in list(itertools.product(isEMlist,nttaglist,nWtaglist,nbtaglist,njetslist))]
