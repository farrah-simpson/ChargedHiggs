...
theDir = 'kinematics_PS_2021_9_25'#kinematics_PS_R18_2021_4_10'#'kinematics_SR_R17_2021_2_10'#'templates_'+year+'_'+sys.argv[3]
...
lumiScaleCoeff = 1. #35867./41530. # Rescale luminosity used in doHists.py
...
systematicList = ['pileup','muRFcorrd','muR','muF','isr','fsr','btag','njet','njetsf','tau32','jmst','jmrt','tau21','jmsW','jmrW','tau21pt']#,'ht','trigeff','toppt','hotstat','hotcspur','hotclosure',
...
ttbarGrupList = ['TTJets']#'ttnobb','ttbb']
bkgGrupList = ['top','ewk','qcd']#ttbarGrupList+['top','ewk','qcd']
...
#bkgProcs['TTJets'] = ['TTJetsSemiLep01','TTJetsSemiLep02','TTJetsSemiLep700','TTJetsSemiLep1000','TTJetsHad0','TTJetsHad700','TTJetsHad1000',
              #'TTJets2L2nu0','TTJets2L2nu700','TTJets2L2nu1000','TTJets700mtt','TTJets1000mtt']  
#if year=='R17': bkgProcs['T']+= ['Tbs']
#if year=='R17': bkgProcs['TTJets']+= ['TTJetsSemiLep03','TTJetsSemiLep04','TTJetsSemiLep05']
bkgProcs['TTV'] = ['TTWl','TTZl']#M10','TTHB','TTHnoB']
...
bkgProcs['top'] = bkgProcs['T']+bkgProcs['TTJets']+bkgProcs['TTV']#+bkgProcs['TTXY']
bkgProcs['ewk'] = bkgProcs['WJets']+bkgProcs['ZJets']+bkgProcs['VV']
dataList = ['DataE','DataM']#,'DataJ']

htProcs = ['ewk','WJets']#,'qcd']
topptProcs = ['top','TTJets'] #['ttjj','ttcc','ttbb','tt1b','tt2b','ttbj','ttnobb']
...
#if whichSignal=='X53' and year == 'R17': 
...
#if whichSignal=='X53' and year == 'R18': 
...
nttaglist = list(set([x.split('_')[0] for x in tagList]))
nWtaglist = list(set([x.split('_')[1] for x in tagList]))
nbtaglist = list(set([x.split('_')[2] for x in tagList]))
njetslist = list(set([x.split('_')[3] for x in tagList]))
