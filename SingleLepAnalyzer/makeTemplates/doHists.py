...
ntupleDir = '/isilon/hadoop/store/user/fsimpson/UL17/step3_XGB_final/nominal/'#'root://cmseos.fnal.gov//store/user/fsimpson/FWLJMET106XUL_singleLep2017UL_RunIISummer20v2_step2/nominal/' 
#ntupleDir  = '/isilon/hadoop/store/user/fsimpson/FWLJMET106XUL_singleLep2017UL_RunIISummer20v2_step2/nominal/'#/UL17/step3_XGB_final/nominal/'
#ntupleDir  = '/isilon/hadoop/store/user/fsimpson/FWLJMET106XUL_singleLep2017UL_RunIISummer20v2_step1hadds/nominal/'#'root://cmseos.fnal.gov//store/user/fsimpson/UL17/step3_XGB/nominal/'
...
iPlot = 'NJets' #choose a discriminant from plotList below!
...
#my final cuts
if region=='CR': cutList = {'lepPtCut':30,'metCut':30,'mtCut':0,'drCut':0,'jet1PtCut':30,'jet2PtCut':30, 'jet3PtCut':0, 'AK4HTCut':1000}#,'XGB':'XGB1300_SR1'}
...
plotList = {#discriminantName:(discriminantLJMETName, binning, xAxisLabel)
	...
	'mindeltaRlb':('minDR_lepBJet',linspace(0,6,51).tolist(),';min[#DeltaR(l,b)]'),
        ...
        'M_allJet_W':('M_allJet_W', linspace(0, 10000, 201).tolist(),';M(allJets, leptonic W) [GeV]'),
