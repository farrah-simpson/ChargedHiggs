...
#HEM issue
#    if 'Data' in process and run_CommonCalc>=319077:
#       cut += ' && ( run_CommonCalc>=319077 && ( leptonEta_MultiLepCalc > -1.3 || ( leptonPhi_MultiLepCalc < -1.57 || leptonPhi_MultiLepCalc > -0.87 ) ) ' 
#       for( ijet=0; ijet < theJetPt_JetSubCalc->size(); ijet++):
#		    cut += ' && ( (isMuon == 1 && deltaR_lepJets[i] < 0.2) || (isElectron == 1) )'
#    cut += ' ) '
#	if 'Data' in process: cut += ' && ( run_CommonCalc>=319077 )'
# 	topPt13TeVstr = '1'
