...
nRun_TTJetsHad = 233617123.0#129706300#129211204.0 # from integral 130262340.0, file TTToHadronic_TuneCP5_PSweights_13TeV-powheg-pythia8_Mtt0to700_hadd.root
nRun_TTJetsSemiLep = 288013524.0#114058500#129706300#109124472.0 # from integral 110085096.0, file TTToSemiLeptonic_TuneCP5_PSweights_13TeV-powheg-pythia8_Mtt0to700_hadd.root
nRun_TTJets2L2nu = 97007882.0#66259900#68595608.0 # from integral 69155808.0, file TTTo2L2Nu_TuneCP5_PSweights_13TeV-powheg-pythia8_Mtt0to700_hadd.root
...
nRun['Ts'] = 8943586.0#19850000#6895750.0 # from integral 6898000.0, file ST_s-channel_top_leptonDecays_13TeV-PSweights_powheg-pythia_hadd.root
...
nRun['Tt'] = 121649602.0 #46206600#122640200.0 # from integral 109621700.0, file ST_t-channel_top_4f_InclusiveDecays_TuneCP5_PSweights_13TeV-powheg-pythia8_hadd.root
...
nRun['TbtW'] = 5673700.0#9191369#7686032.0 # from integral 7745276.0, file ST_tW_antitop_5f_inclusiveDecays_TuneCP5_PSweights_13TeV-powheg-pythia8_hadd.root
...
nRun['WJetsMG400'] = 5468473.0#14189363.0 # from integral 14252285.0, file WJetsToLNu_HT-400To600_TuneCP5_13TeV-madgraphMLM-pythia8_hadd.root
nRun['WJetsMG600'] = 4954117.0#21330497.0 # from integral 21455857.0, file WJetsToLNu_HT-600To800_TuneCP5_13TeV-madgraphMLM-pythia8_hadd.root
nRun['WJetsMG800'] = 3921170.0#20272990.0 # from integral 20432728.0, file WJetsToLNu_HT-800To1200_TuneCP5_13TeV-madgraphMLM-pythia8_hadd.root
nRun['WJetsMG1200'] = 4006969.0#19950628.0 # from integral 20216830.0, file WJetsToLNu_HT-1200To2500_TuneCP5_13TeV-madgraphMLM-pythia8_hadd.root
nRun['WJetsMG2500'] = 1185699.0 # from integral 21495421.0, file WJetsToLNu_HT-2500ToInf_TuneCP5_13TeV-madgraphMLM-pythia8_hadd.root
...
nRun['DYMG200'] = 12513057.0 #double check # from integral 10728447.0, file DYJetsToLL_M-50_HT-200to400_TuneCP5_13TeV-madgraphMLM-pythia8_hadd.root
nRun['DYMG400'] = 5481796.0 # from integral 10219524.0, file DYJetsToLL_M-50_HT-400to600_TuneCP5_13TeV-madgraphMLM-pythia8_hadd.root
nRun['DYMG600'] = 5278417.0 # double check from integral 8743640.0, file DYJetsToLL_M-50_HT-600to800_TuneCP5_13TeV-madgraphMLM-pythia8_hadd.root
nRun['DYMG800'] = 4506887.0 # high check from integral 3114980.0, file DYJetsToLL_M-50_HT-800to1200_TuneCP5_13TeV-madgraphMLM-pythia8_hadd.root
nRun['DYMG1200']= 4802716.0 # from integral 625517.0, file DYJetsToLL_M-50_HT-1200to2500_TuneCP5_13TeV-madgraphMLM-pythia8_hadd.root
nRun['DYMG2500']=  1480047.0 # from integral 419308.0, file DYJetsToLL_M-50_HT-2500toInf_TuneCP5_13TeV-madgraphMLM-pythia8_hadd.root

nRun['WW'] = 15634000.0#7765828.0 # from integral 7765828.0, file WW_TuneCP5_13TeV-pythia8_hadd.root
nRun['WZ'] = 7889000.0#3928567.0 # from integral 3928630.0, file WZ_TuneCP5_13TeV-pythia8_hadd.root
nRun['ZZ'] = 2706000.0#1925931.0 # from integral 1925931.0, file ZZ_TuneCP5_13TeV-pythia8_hadd.root

nRun['QCDht100'] = 77775408#80684349.
nRun['QCDht200'] = 42714435.0#65436493.0 # from integral 59074480.0, file QCD_HT200to300_TuneCP5_13TeV-madgraph-pythia8_hadd.root
...
nRun['QCDht500'] = 36194860.0#56041018.0 # from integral 56207744.0, file QCD_HT500to700_TuneCP5_13TeV-madgraph-pythia8_hadd.root
...
nRun['QCDht2000'] = 4112573.0#5825566.0 # from integral 5941306.0, file QCD_HT2000toInf_TuneCP5_13TeV-madgraph-pythia8_hadd.root
...
nRun['TTWl'] = 4044869.0#5216439#2742430.0 # from integral, file TTWJetsToLNu_TuneCP5_PSweights_13TeV-amcatnloFXFX-madspin-pythia8_hadd.root
nRun['TTWq'] = 359006.0# from integral 811306.0, file TTWJetsToQQ_TuneCP5_13TeV-amcatnloFXFX-madspin-pythia8_hadd.root
nRun['TTZlM10'] = 6990534.0#14000000# 5239484.0 # from integral, file TTZToLLNuNu_M-10_TuneCP5_PSweights_13TeV-amcatnlo-pythia8_hadd.root
nRun['TTZlM1to10'] = 390602.0
nRun['TTZq'] = 351164. # from 749400
nRun['TTHB'] = 7661778.0 # low from integral 8000000.0, file ttHTobb_M125_TuneCP5_13TeV-powheg-pythia8_hadd.root
nRun['TTHnoB'] = 4965389.0 # from integral 7161154.0, file ttHToNonbb_M125_TuneCP5_13TeV-powheg-pythia8_hadd.root

nRun['TTHH'] = 360000.0 # low from integral, file TTHH_TuneCP5_13TeV-madgraph-pythia8_hadd.root
nRun['TTTJ'] = 354000.0 #update! # from integral, file TTTJ_TuneCP5_13TeV-madgraph-pythia8_hadd.root
nRun['TTTW'] = 360000.0 #update! from integral, file TTTW_TuneCP5_13TeV-madgraph-pythia8_hadd.root
nRun['TTWH'] = 360000.0 # from integral, file TTWH_TuneCP5_13TeV-madgraph-pythia8_hadd.root
nRun['TTWW'] = 698000.0 # from integral, file TTWW_TuneCP5_13TeV-madgraph-pythia8_hadd.root
nRun['TTWZ'] = 350000.0 # from integral, file TTWZ_TuneCP5_13TeV-madgraph-pythia8_hadd.root
nRun['TTZH'] = 350000.0 # from integral, file TTZH_TuneCP5_13TeV-madgraph-pythia8_hadd.root
nRun['TTZZ'] = 327000.0 # from integral, file TTZZ_TuneCP5_13TeV-madgraph-pythia8_hadd.root
...
nRun['X53RHM700'] = 300000.0
nRun['X53LHM800'] = 295600.
nRun['X53RHM800'] = 300000.0
nRun['X53LHM900'] = 300000. #old
nRun['X53RHM900'] = 298000.0
nRun['X53LHM1000'] = 293600.#old
nRun['X53RHM1000'] = 289000.0
nRun['X53LHM1100'] = 284174.0
nRun['X53RHM1100'] = 297000.0
nRun['X53LHM1200'] = 252566.0 
nRun['X53RHM1200'] = 296000.0
nRun['X53LHM1300'] = 300000. #old
nRun['X53RHM1300'] = 300000.0
nRun['X53LHM1400'] = 251084.0
nRun['X53RHM1400'] = 300000.0
nRun['X53LHM1500'] = 298400. #old
nRun['X53RHM1500'] = 287000.0
nRun['X53LHM1600'] = 300000. #old
nRun['X53RHM1600'] = 299000.0
nRun['X53LHM1700'] = 193068.0
nRun['X53RHM1700'] = 299000.0 
nRun['X53M600MH200']= 300000.0
nRun['X53M600MH400']= 296000.0
nRun['X53M700MH200']= 300000.0
nRun['X53M700MH400']= 295000.0
nRun['X53M800MH200']= 298000.0
nRun['X53M800MH400']= 300000.0
nRun['X53M800MH600']= 300000.0
nRun['X53M900MH200']= 300000.0
nRun['X53M900MH400']= 300000.0
nRun['X53M900MH600']= 300000.0
nRun['X53M1000MH200']= 300000.0
nRun['X53M1000MH400']= 300000.0
nRun['X53M1000MH600']= 300000.0
nRun['X53M1000MH800']= 300000.0
nRun['X53M1100MH200']= 300000.0
nRun['X53M1100MH400']= 300000.0
nRun['X53M1100MH600']= 300000.0
nRun['X53M1100MH800']= 300000.0
nRun['X53M1200MH200']= 300000.0
nRun['X53M1200MH400']= 299000.0
nRun['X53M1200MH600']= 300000.0
nRun['X53M1200MH800']= 298000.0
nRun['X53M1200MH1000']= 298000.0
nRun['X53M1300MH200']= 234000.0
nRun['X53M1300MH400']= 295000.0
nRun['X53M1300MH600']= 296000.0
nRun['X53M1300MH800']= 299000.0
nRun['X53M1300MH1000']= 295000.0
nRun['X53M1400MH200']= 297000.0
nRun['X53M1400MH400']= 297000.0
nRun['X53M1400MH600']= 296000.0
nRun['X53M1400MH800']= 299000.0
nRun['X53M1400MH1000']= 298000.0
nRun['X53M1500MH200']= 296000.0
nRun['X53M1500MH400']= 300000.0
nRun['X53M1500MH600']= 293000.0 
nRun['X53M1500MH800']= 293000.0
nRun['X53M1500MH1000']= 296000.0
nRun['X53M1600MH200']= 275000.0
nRun['X53M1600MH400']= 299000.0
nRun['X53M1600MH600']= 300000.0 
nRun['X53M1600MH800']= 299000.0
nRun['X53M1600MH1000']= 300000.0
nRun['X53M1700MH200']= 300000.0
nRun['X53M1700MH400']= 300000.0
nRun['X53M1700MH600']= 300000.0 
nRun['X53M1700MH800']= 271000.0
nRun['X53M1700MH1000']= 300000.0
